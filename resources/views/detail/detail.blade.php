...
<body>
            ...
            <ul class="navbar-nav menu-list list-unstyled d-flex gap-md-3 mb-0">
              ...
              <li class="nav-item">
                <a href="https://templatesjungle.gumroad.com/l/waggy-pet-shop-ecommerce-html-website-template"
                  class="nav-link fw-bold text-dark" target="_blank"></a>
              </li>
            </ul>
  ...
  <section id="foodies" class="my-5">
    <div class="container my-5 py-5">
      <div class="row">
        <div class="col-md-6 swiper mySwiper">
          <div class="swiper-wrapper">
            @foreach (json_decode($product->foto) as $photo)
              <div class="swiper-slide">
              <img src="{{ Storage::url($photo) }}" alt="foto" style="">
              </div>
            @endforeach
          </div>
        ...
        <div class="col-md-6" style="height: fit-content">
          <h1 class="display-4">{{ $product->nama }}</h1>
          <p class="lead">{{ $product->desc }}</p>
          <h3 class="text-primary">Rp {{ $product->hargajual }}</h3>
          <div class="d-flex flex-wrap mt-3">
            <a href="#" class="btn btn-primary me-3 px-4 pt-3 pb-3">
              <h5 class="text-uppercase m-0">Add to Cart</h5>
            </a>
            <a href="#" class="btn btn-secondary px-4 pt-3">
