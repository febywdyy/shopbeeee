    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4" style="height: 100vh">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          {{-- <div class="image">
            <img src="dist/img/user2-160x160.jpg" class="img-circle elexvation-2" alt="User Image">
          </div> --}}
          <div class="info">
            <a href="#" class="d-block">Feby Widya Yanti Lubis</a>
          </div>
        </div>
...
<!-- 
          ...
          <li class="nav-item">
              <a href="{{ route('logout') }}" class="nav-link">
                ...
                </svg><p> Logout<i class="fas fa-angle-left right"></i>
                  <span class="badge badge-info right"></span></p>
              </a>
        </nav>
        <!-- /.sidebar-menu -->
      </div>
          ...
          <div class="col-lg-6">
            <div class="card">
              <div class="card-header border-0">
                @section('content')<div class="d-flex justify-content-between">
  ...
  <script src="{{ url('lte/ltedist/js/demo.js')}}"></script>
